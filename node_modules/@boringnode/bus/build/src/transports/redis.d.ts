...
import { RedisTransportConfig, TransportEncoder, Transport, RedisTransportOptions, Serializable, SubscribeHandler } from '../types/main.js';
import 'mqtt';
...
declare class RedisTransport implements Transport {
    ...
    constructor(connection: Redis | Cluster, encoder?: TransportEncoder, options?: RedisTransportOptions);
