...
const AdminDepartmentsController = () =>
  import('../src/controllers/admin_departments_controller.js')
const AdminTagsController = () => import('../src/controllers/admin_tags_controller.js')
const AdminSlaPoliciesController = () =>
  import('../src/controllers/admin_sla_policies_controller.js')
const AdminEscalationRulesController = () =>
  import('../src/controllers/admin_escalation_rules_controller.js')
const AdminCannedResponsesController = () =>
...
function registerCoreRoutes(config: any) {
  ...
  if (config.inboundEmail?.enabled) {
    router
      .group(() => {
        router
          .post('/:adapter', [InboundEmailController, 'webhook'])
          .as('escalated.inbound.webhook')
...
function registerUiRoutes(config: any) {
  ...
  router
    .group(() => {
      ...
      router
        .get('/create', [CustomerTicketsController, 'create'])
        .as('escalated.customer.tickets.create')
      ...
      router
        .group(() => {
          router
            .get('/:ticket', [CustomerTicketsController, 'show'])
            .as('escalated.customer.tickets.show')
          router
            .post('/:ticket/reply', [CustomerTicketsController, 'reply'])
            .as('escalated.customer.tickets.reply')
          router
            .post('/:ticket/close', [CustomerTicketsController, 'close'])
            .as('escalated.customer.tickets.close')
          router
            .post('/:ticket/reopen', [CustomerTicketsController, 'reopen'])
            .as('escalated.customer.tickets.reopen')
          router
  ...
  router
    .group(() => {
      ...
      router
        .group(() => {
          router
            .get('/tickets/:ticket', [AgentTicketsController, 'show'])
            .as('escalated.agent.tickets.show')
          router
            .put('/tickets/:ticket', [AgentTicketsController, 'update'])
            .as('escalated.agent.tickets.update')
          router
            .post('/tickets/:ticket/reply', [AgentTicketsController, 'reply'])
            .as('escalated.agent.tickets.reply')
          router
            .post('/tickets/:ticket/note', [AgentTicketsController, 'note'])
            .as('escalated.agent.tickets.note')
          router
            .post('/tickets/:ticket/assign', [AgentTicketsController, 'assign'])
            .as('escalated.agent.tickets.assign')
          router
            .post('/tickets/:ticket/status', [AgentTicketsController, 'status'])
            .as('escalated.agent.tickets.status')
          router
            .post('/tickets/:ticket/priority', [AgentTicketsController, 'priority'])
            .as('escalated.agent.tickets.priority')
          router
          ...
          router
            .post('/tickets/:ticket/presence', [AgentTicketsController, 'presence'])
            .as('escalated.agent.tickets.presence')
          router
  ...
  router
    .group(() => {
      ...
      router
        .post('/tickets/bulk', [BulkActionsController, 'handle'])
        .as('escalated.admin.tickets.bulk')

      router
        .group(() => {
          router
            .get('/tickets/:ticket', [AdminTicketsController, 'show'])
            .as('escalated.admin.tickets.show')
          router
            .post('/tickets/:ticket/reply', [AdminTicketsController, 'reply'])
            .as('escalated.admin.tickets.reply')
          router
            .post('/tickets/:ticket/note', [AdminTicketsController, 'note'])
            .as('escalated.admin.tickets.note')
          router
            .post('/tickets/:ticket/assign', [AdminTicketsController, 'assign'])
            .as('escalated.admin.tickets.assign')
          router
            .post('/tickets/:ticket/status', [AdminTicketsController, 'status'])
            .as('escalated.admin.tickets.status')
          router
            .post('/tickets/:ticket/priority', [AdminTicketsController, 'priority'])
            .as('escalated.admin.tickets.priority')
          router
          ...
          router
            .post('/tickets/:ticket/macro', [AdminTicketsController, 'applyMacro'])
            .as('escalated.admin.tickets.macro')
          router
            .post('/tickets/:ticket/follow', [AdminTicketsController, 'follow'])
            .as('escalated.admin.tickets.follow')
          router
            .post('/tickets/:ticket/presence', [AdminTicketsController, 'presence'])
            .as('escalated.admin.tickets.presence')
          router
      ...
      router
        ...
        .as('escalated.admin.departments.index')
      router
        .get('/departments/create', [AdminDepartmentsController, 'create'])
        .as('escalated.admin.departments.create')
      router
        .post('/departments', [AdminDepartmentsController, 'store'])
        .as('escalated.admin.departments.store')
      router
        .get('/departments/:id/edit', [AdminDepartmentsController, 'edit'])
        .as('escalated.admin.departments.edit')
      router
        .put('/departments/:id', [AdminDepartmentsController, 'update'])
        .as('escalated.admin.departments.update')
      router
        .delete('/departments/:id', [AdminDepartmentsController, 'destroy'])
        .as('escalated.admin.departments.destroy')

      // SLA Policies CRUD
      router
        .get('/sla-policies', [AdminSlaPoliciesController, 'index'])
        .as('escalated.admin.sla-policies.index')
      router
        .get('/sla-policies/create', [AdminSlaPoliciesController, 'create'])
        .as('escalated.admin.sla-policies.create')
      router
        .post('/sla-policies', [AdminSlaPoliciesController, 'store'])
        .as('escalated.admin.sla-policies.store')
      router
        .get('/sla-policies/:id/edit', [AdminSlaPoliciesController, 'edit'])
        .as('escalated.admin.sla-policies.edit')
      router
        .put('/sla-policies/:id', [AdminSlaPoliciesController, 'update'])
        .as('escalated.admin.sla-policies.update')
      router
        .delete('/sla-policies/:id', [AdminSlaPoliciesController, 'destroy'])
        .as('escalated.admin.sla-policies.destroy')

      // Escalation Rules CRUD
      router
        .get('/escalation-rules', [AdminEscalationRulesController, 'index'])
        .as('escalated.admin.escalation-rules.index')
      router
        .get('/escalation-rules/create', [AdminEscalationRulesController, 'create'])
        .as('escalated.admin.escalation-rules.create')
      router
        .post('/escalation-rules', [AdminEscalationRulesController, 'store'])
        .as('escalated.admin.escalation-rules.store')
      router
        .get('/escalation-rules/:id/edit', [AdminEscalationRulesController, 'edit'])
        .as('escalated.admin.escalation-rules.edit')
      router
        .put('/escalation-rules/:id', [AdminEscalationRulesController, 'update'])
        .as('escalated.admin.escalation-rules.update')
      router
        .delete('/escalation-rules/:id', [AdminEscalationRulesController, 'destroy'])
        .as('escalated.admin.escalation-rules.destroy')
      ...
      // Canned Responses
      router
        .get('/canned-responses', [AdminCannedResponsesController, 'index'])
        .as('escalated.admin.canned-responses.index')
      router
        .post('/canned-responses', [AdminCannedResponsesController, 'store'])
        .as('escalated.admin.canned-responses.store')
      router
        .put('/canned-responses/:cannedResponse', [AdminCannedResponsesController, 'update'])
        .as('escalated.admin.canned-responses.update')
      router
        .delete('/canned-responses/:cannedResponse', [AdminCannedResponsesController, 'destroy'])
        .as('escalated.admin.canned-responses.destroy')
      ...
      router
        .put('/macros/:macro', [AdminMacrosController, 'update'])
        .as('escalated.admin.macros.update')
      router
        .delete('/macros/:macro', [AdminMacrosController, 'destroy'])
        .as('escalated.admin.macros.destroy')

      // API Tokens CRUD
      router
        .get('/api-tokens', [AdminApiTokensController, 'index'])
        .as('escalated.admin.api-tokens.index')
      router
        .post('/api-tokens', [AdminApiTokensController, 'store'])
        .as('escalated.admin.api-tokens.store')
      router
        .put('/api-tokens/:id', [AdminApiTokensController, 'update'])
        .as('escalated.admin.api-tokens.update')
      router
      ...
      router
        .get('/import/create', [AdminImportController, 'create'])
        .as('escalated.admin.import.create')
      ...
      router
        .get('/import/:id/mapping', [AdminImportController, 'mapping'])
        .as('escalated.admin.import.mapping')
      router
        .post('/import/:id/mapping', [AdminImportController, 'saveMapping'])
        .as('escalated.admin.import.saveMapping')
      router
        .post('/import/:id/start', [AdminImportController, 'start'])
        .as('escalated.admin.import.start')
      router
        .post('/import/:id/pause', [AdminImportController, 'pause'])
        .as('escalated.admin.import.pause')
      router
        .delete('/import/:id', [AdminImportController, 'destroy'])
        .as('escalated.admin.import.destroy')

      // Automations CRUD
      router
        .get('/automations', [AdminAutomationsController, 'index'])
        .as('escalated.admin.automations.index')
      router
        .get('/automations/create', [AdminAutomationsController, 'create'])
        .as('escalated.admin.automations.create')
      router
        .post('/automations', [AdminAutomationsController, 'store'])
        .as('escalated.admin.automations.store')
      router
        .get('/automations/:id/edit', [AdminAutomationsController, 'edit'])
        .as('escalated.admin.automations.edit')
      router
        .put('/automations/:id', [AdminAutomationsController, 'update'])
        .as('escalated.admin.automations.update')
      router
      ...
      router
        .post('/plugins/upload', [AdminPluginsController, 'upload'])
        .as('escalated.admin.plugins.upload')
      router
        .post('/plugins/:slug/activate', [AdminPluginsController, 'activate'])
        .as('escalated.admin.plugins.activate')
      router
        .post('/plugins/:slug/deactivate', [AdminPluginsController, 'deactivate'])
        .as('escalated.admin.plugins.deactivate')
      router
  ...
  router
    .group(() => {
      ...
      router
        ...
        .as('escalated.guest.tickets.rate')
        .where('token', /^[A-Za-z0-9]{64}$/)
    })
    .prefix(`${prefix}/guest`)
}
...
export function registerApiRoutes(config: any) {
  ...
  router
    .group(() => {
      // Auth
      router
        .post('/auth/validate', [ApiAuthController, 'validate'])
        .as('escalated.api.auth.validate')
      ...
      router
        .group(() => {
          router
            .get('/tickets/:ticket', [ApiTicketController, 'show'])
            .as('escalated.api.tickets.show')
          router
            .post('/tickets/:ticket/reply', [ApiTicketController, 'reply'])
            .as('escalated.api.tickets.reply')
          router
            .patch('/tickets/:ticket/status', [ApiTicketController, 'status'])
            .as('escalated.api.tickets.status')
          router
            .patch('/tickets/:ticket/priority', [ApiTicketController, 'priority'])
            .as('escalated.api.tickets.priority')
          router
            .post('/tickets/:ticket/assign', [ApiTicketController, 'assign'])
            .as('escalated.api.tickets.assign')
          router
            .post('/tickets/:ticket/follow', [ApiTicketController, 'follow'])
            .as('escalated.api.tickets.follow')
          router
      ...
      router
        .get('/departments', [ApiResourceController, 'departments'])
        .as('escalated.api.departments')
      router.get('/tags', [ApiResourceController, 'tags']).as('escalated.api.tags')
      router
        .get('/canned-responses', [ApiResourceController, 'cannedResponses'])
        .as('escalated.api.canned-responses')
      router.get('/macros', [ApiResourceController, 'macros']).as('escalated.api.macros')

      // Realtime
      router
        .get('/realtime/config', [ApiResourceController, 'realtimeConfig'])
